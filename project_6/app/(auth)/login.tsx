      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          ...
          <View style={styles.footer}>
            <Link href="/register" style={styles.link}>Створити акаунт</Link>
            <Link href="/forgot-password" style={styles.linkMuted}>Забули пароль?</Link>
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#3b82f6', paddingVertical: 14, borderRadius: 10, alignItems: 'center', marginTop: 8, shadowColor: '#3b82f6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 4 },
  primaryButtonText: { color: '#ffffff', fontSize: 16, fontWeight: '700' },
  footer: { marginTop: 24, alignItems: 'center', gap: 12 },
  link: { color: '#3b82f6', fontSize: 15, fontWeight: '600' },
  linkMuted: { color: '#6b7280', fontSize: 14, marginTop: 10 }
});
